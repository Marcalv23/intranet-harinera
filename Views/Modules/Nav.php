             ...
             <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <a class="nav-link dropdown-indicator" href="#formularios" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="formularios">
                 ...
                 <li class="nav-item">
                     ...
                     <a class="nav-link" href="configFormu" role="button">
                         <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-wrench"></span></span><span class="nav-link-text ps-1">Configurar formularios</span>
                         </div>
                     </a>
                 </li>
