...
<!-- Incluir JavaScript de Bootstrap (colócalo al final del body) -->
                            ...
                            <div class="row g-0 h-100">
                                <div class="col-md-5 text-center bg-card-gradient">
                                    ...
                                    <div class="mt-3 mb-4 mt-md-4 mb-md-5" data-bs-theme="light">
                                        ...
                                        Lea nuestro <a class="text-decoration-underline text-white" href="../Views/Pages/Aviso/Aviso.php">aviso de privacidad</a> o 
                                        <a class="text-decoration-underline text-white" href="../Views/Pages/Aviso/descargar_aviso.php">descárguelo en PDF</a>.
                                        </p>
                                        <p class="mb-0 mt-4 mt-md-5 fs-10 fw-semi-bold text-white opacity-75">
                                        <a class="text-decoration-underline text-white" href="../Views/Pages/Aviso/acuerdo.php">Acuerdo de confidencialidad</a> o 
                                        <a class="text-decoration-underline text-white" href="../Views/Pages/Aviso/descargar_aviso.php">descárguelo en PDF</a>.
                                        </p>
                                    </div>
                                    ...
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        ...
                                        <form action="login.php" method="POST">
                                            ...
                                            <div class="row flex-between-center">
                                                ...
                                                <div class="col-auto"><a class="fs-10" href="forgot-password.php">Olvidaste de contraseña?</a></div>
                                            </div>
                                            <div class="mb-3">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="termsModalLabel">Términos de uso del software</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <p>
                                    Al utilizar este software, aceptas cumplir con los siguientes términos y condiciones:
                                </p>

                                <ul>
                                    <li><strong>Aceptación de los Términos:</strong> Al descargar, instalar o utilizar este software, aceptas estar legalmente vinculado por estos términos. Si no estás de acuerdo, no debes utilizar el software.</li>
                                    <li><strong>Licencia de Uso:</strong> El software se proporciona bajo una licencia limitada, no exclusiva y no transferible. No puedes redistribuir, vender o explotar el software comercialmente sin autorización.</li>
                                    <li><strong>Propiedad Intelectual:</strong> Todos los derechos de propiedad intelectual relacionados con el software son propiedad exclusiva del proveedor.</li>
                                    <li><strong>Restricciones de Uso:</strong> Te comprometes a no modificar, descompilar o realizar ingeniería inversa en el software, ni usarlo para fines ilegales.</li>
                                    <li><strong>Actualizaciones y Cambios:</strong> El proveedor puede lanzar actualizaciones periódicas. El uso de versiones desactualizadas está bajo tu propio riesgo.</li>
                                    <li><strong>Limitación de Responsabilidad:</strong> El software es proporcionado "tal cual" sin garantías de ningún tipo. El proveedor no se hace responsable de cualquier daño derivado del uso del software.</li>
                                </ul>

                                <p>Si tienes preguntas o inquietudes sobre estos términos, por favor, contacta al proveedor del software.</p>
                            </div>
